...
use App\Controller\ObservationsControllers\Interfaces\AddObservationControllerInterface;
...
class AddObservationController implements AddObservationControllerInterface
{
    ...
    public function addObservation(Request $request)
    {
        ...
        return new Response($this->twig->render('observations/addObservation.html.twig',array('form' => $form->createView(),'observation' => $observation)));
