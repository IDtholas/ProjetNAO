...
class ObservationPageController
{
    private $twig;
    ...
    public function specificObservation($id,Request $request)
{
 ...
 return new Response( $this->twig->render ('specificObservation.html.twig', ['observation'=> $observation, 'comments' => $comments, 'form' =>  $form->createView()]));
}
